...
import { formatMetric, metricDelta, PRS } from "@/lib/mock-data";
							...
							return (
								<tr key={p.id} className="hover:bg-muted/30">
									...
									<td className="px-5 py-3 font-mono">
										...
										<span
											className={`text-xs ml-1 ${lcpD.better ? "text-success" : "text-destructive"}`}
										>
											{lcpD.diff >= 0 ? "+" : ""}
											{lcpD.pct.toFixed(0)}%
										</span>
									...
									<td className="px-5 py-3 font-mono">
										...
										<span
											className={`text-xs ml-1 ${perfD.better ? "text-success" : "text-destructive"}`}
										>
											{perfD.diff >= 0 ? "+" : ""}
											{perfD.diff}
										</span>
